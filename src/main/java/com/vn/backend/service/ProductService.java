...
public class ProductService {
    ...
    public ProductResponse updateProduct(Long id, UpdateProductRequest request) {
        ...
        // 3. Update Basic Fields (Giữ nguyên logic kiểm tra null để support PATCH update)
        ...
        if (request.getNumberOfPages() != null) product.setNumberOfPages(request.getNumberOfPages());
        if (request.getIsbn() != null) product.setIsbn(request.getIsbn());
        if (request.getStockQuantity() != null) product.setStockQuanity(request.getStockQuantity());
        ...
        if (request.getPublisherDate() != null) product.setPublisherDate(request.getPublisherDate());
